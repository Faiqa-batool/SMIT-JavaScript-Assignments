...
// let arr1 = [1, [22, 'hello', [true, 'university']],'Ye-jin'];
...
// document.write("Counting 1 to 10: ");
// for (let i=1; i<11; i++){
//     document.write("<br>");
//     document.write(i);
...
// tableNum = +prompt("Enter a number to show its multiplication table: ");
// tableLength = +prompt("Enter length of multiplication table: ");
